...
const template = `
아래와 같은 사항을 준수해야합니다.
* 당신은 주어진 주제와 목차를 바탕으로 책 내용을 보강해야합니다.
...
class ContentCreator {
    async execute(OPEN_AI_API_KEY, subject, indexes) {
        const items = Array.from({ length: indexes.length });
        const { OpenAI } = await Promise.resolve().then(() => __nccwpck_require__(147));
        const model = new OpenAI({
            openAIApiKey: OPEN_AI_API_KEY,
            modelName: 'gpt-3.5-turbo',
            temperature: 1,
        });
        await Promise.all(indexes.map(async (index, position) => {
...
exports["default"] = ContentCreator;
...
`;
class IndexCreator {
    async execute(OPEN_AI_API_KEY, subject) {
        const { OpenAI } = await Promise.resolve().then(() => __nccwpck_require__(147));
        const model = new OpenAI({
            openAIApiKey: OPEN_AI_API_KEY,
            modelName: 'gpt-3.5-turbo',
...
exports["default"] = IndexCreator;
//# sourceMappingURL=IndexCreator.js.map
...
var _v = _interopRequireDefault(__nccwpck_require__(868));

var _v2 = _interopRequireDefault(__nccwpck_require__(2528));

var _v3 = _interopRequireDefault(__nccwpck_require__(2509));

var _v4 = _interopRequireDefault(__nccwpck_require__(9106));

var _nil = _interopRequireDefault(__nccwpck_require__(5389));

var _version = _interopRequireDefault(__nccwpck_require__(7660));

var _validate = _interopRequireDefault(__nccwpck_require__(9475));

var _stringify = _interopRequireDefault(__nccwpck_require__(7309));

var _parse = _interopRequireDefault(__nccwpck_require__(6698));
...
var _rng = _interopRequireDefault(__nccwpck_require__(534));

var _stringify = __nccwpck_require__(7309);
...
var _md = _interopRequireDefault(__nccwpck_require__(7278));
...
var _native = _interopRequireDefault(__nccwpck_require__(4196));
...
var _sha = _interopRequireDefault(__nccwpck_require__(2594));
...
var _regex = _interopRequireDefault(__nccwpck_require__(1830));
...
const tiktoken_js_1 = __nccwpck_require__(5400);
...
class BaseLanguageModel extends BaseLangChain {
    ...
    static async deserialize(data) {
        ...
        const Cls = {
            openai: (await Promise.all(/* import() */[__nccwpck_require__.e(613), __nccwpck_require__.e(990)]).then(__nccwpck_require__.bind(__nccwpck_require__, 8990))).ChatOpenAI,
        }[_type];
        if (Cls === undefined) {
 ...
 */
var count_tokens_js_2 = __nccwpck_require__(6092);
...
const object_hash_1 = __importDefault(__nccwpck_require__(4856));
/**
...
const base_js_1 = __nccwpck_require__(7295);
const index_js_1 = __nccwpck_require__(1445);
...
const ansi_styles_1 = __importDefault(__nccwpck_require__(8964));
const tracer_js_1 = __nccwpck_require__(4107);
...
const tracer_langchain_js_1 = __nccwpck_require__(521);
const tracer_langchain_v1_js_1 = __nccwpck_require__(9159);
...
const base_js_1 = __nccwpck_require__(7656);
...
const async_caller_js_1 = __nccwpck_require__(3382);
const env_js_1 = __nccwpck_require__(1548);
const tracer_js_1 = __nccwpck_require__(4107);
...
const base_js_1 = __nccwpck_require__(4235);
const env_js_1 = __nccwpck_require__(1548);
const tracer_js_1 = __nccwpck_require__(4107);
...
const base_js_1 = __nccwpck_require__(7656);
const console_js_1 = __nccwpck_require__(2533);
const initialize_js_1 = __nccwpck_require__(5814);
const base_js_2 = __nccwpck_require__(4235);
const env_js_1 = __nccwpck_require__(1548);
...
const index_js_1 = __nccwpck_require__(55);
const index_js_2 = __nccwpck_require__(1445);
const index_js_3 = __nccwpck_require__(6691);
const manager_js_1 = __nccwpck_require__(5128);
const base_js_1 = __nccwpck_require__(4235);
/**
...
class BaseLLM extends index_js_3.BaseLanguageModel {
    ...
    static async deserialize(data) {
        ...
        const Cls = {
            openai: (await Promise.all(/* import() */[__nccwpck_require__.e(613), __nccwpck_require__.e(885)]).then(__nccwpck_require__.bind(__nccwpck_require__, 6885))).OpenAI,
        }[_type];
        if (Cls === undefined) {
            throw new Error(`Cannot load  LLM with type ${_type}`);
        }
...
const base_js_1 = __nccwpck_require__(9892);
const prompt_layer_js_1 = __nccwpck_require__(6738);
/**
...
const env_js_1 = __nccwpck_require__(1548);
const axios_fetch_adapter_js_1 = __importDefault(__nccwpck_require__(7262));
const chunk_js_1 = __nccwpck_require__(1769);
const base_js_1 = __nccwpck_require__(9892);
const count_tokens_js_1 = __nccwpck_require__(6092);
const openai_chat_js_1 = __nccwpck_require__(5547);
const prompt_layer_js_1 = __nccwpck_require__(6738);
/**
...
var openai_chat_js_2 = __nccwpck_require__(5547);
...
const p_retry_1 = __importDefault(__nccwpck_require__(2548));
...
const event_source_parse_js_1 = __nccwpck_require__(657);
...
const lite_1 = __nccwpck_require__(3791);
const async_caller_js_1 = __nccwpck_require__(3382);
const cache = {};
...
const IndexCreator_1 = __nccwpck_require__(5028);
const ContentCreator_1 = __nccwpck_require__(3529);
const OPEN_AI_API_KEY = core.getInput('open_ai_api_key');
const TITLE = core.getInput('title');
async function main() {
    const indexCreator = new IndexCreator_1.default();
    const indexes = await indexCreator.execute(OPEN_AI_API_KEY, TITLE);
    const contentCreator = new ContentCreator_1.default();
